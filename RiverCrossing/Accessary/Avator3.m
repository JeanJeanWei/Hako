...
//    {
//        case kStateIdle:
//            //  [self setDisplayFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"fran_standFront_1.png"]];
...
- (id)init
{
    ...
    if (self != nil)
    {
        ...
        [self onExit];
        [self setDisplayFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"musume1_idle_1.png"]];
        self.characterState = kStateIdle;
